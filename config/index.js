export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx59a4779d96f1ce7c",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "3eb58ee1d4684d22ead7923340a0f288",
  ...
  USERS: [
    {
      ...
      id: "o_kLL6TRdzt7JR9WywOQ2KHTtyMU,o_kLL6cGfigNGcRRpVsTQqt2rY1I",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "DntYi24GXL1i0wycT07fvKI2xpuWR3l6vDyJSNaaHG8",
      // 所在省份
      province: "安徽",
      // 所在城市
      city: "合肥",
      ...
      festivals: [
        ...
        {"type": "生日", "name": "晶晶", "year": "2000", "date": "04-20"},
  ...
  CALLBACK_TEMPLATE_ID: "DntYi24GXL1i0wycT07fvKI2xpuWR3l6vDyJSNaaHG8",
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "o_kLL6cGfigNGcRRpVsTQqt2rY1I",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
